...
const { getUserData, updateUserData, createOrUpdateUser,readUserData } = require('../utils/helpers.js');
     ...
     const targetUser = interaction.options.getUser('user');
      ...
      try {
        ...
        if (!userData[targetUser.id]) {
          return interaction.reply({ content: 'This user has not started their journey yet.', ephemeral: true });
        }
